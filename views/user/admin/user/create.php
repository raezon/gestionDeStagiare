                    ...
                    <div class="col-md-9">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <?= $this->render('_form', ['form' => $form, 'user' => $user,'authItem'=> $authItem]) ?>
                                <!-- //Yii::$app->controller->make(Grade::class, ['form'=>$form,'user' => $user, 'grade' => $grade])->run()?>-->
